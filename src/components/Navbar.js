...
function Navbar(props) {
  ...
  return (
    <div className="text-2xl font-bold grid grid-flow-col p-4 h-8 gap-8 lg:gap-96 sticky ease-out duration-300">
      ...
      <button className="justify-self-center" onClick={() => navigate('/shop')}>
        <span className="link link-underline link-underline-black">Shop</span>
      </button>
